...
/**
 * Set the authentication logic (check if user is authenticated)
 * @param {*} req request token from headers
 * @param {*} res if fail response with some meassage
 * @param {*} next if success continu
 */
...
/**
 * Set the authorization logic (check if user is authorized to do some action)
 * @param {*} req 
 * @param {*} res 
 * @param {*} next 
 */
